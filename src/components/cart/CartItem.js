    ...
    <>
      <div className='flex items-center justify-between w-full'>
        ...
        <div className='flex items-center gap-5'>
          ...
          <div className="grid items-center gap-4">
            ...
            <div className="flex items-center justify-around w-full ">
              <button className='bg-theme-cart rounded h-6 w-6 lg:w-5 lg:h-5 flex items-center justify-center hover:scale-90' type="button">
        ...
        <div className="grid items-center gap-5">
          ...
          <div className="grid items-center justify-items-center">
            <button className='bg-theme-cart rounded text-white p-1 lg:p-0.5 grid items-center justify-items-center' type="button">
