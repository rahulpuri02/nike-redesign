...
import { closeCart, selectCartState, selectCartItems, clearCartItems, subtotal, selectCartTotalAmount, selectCartTotalQuantity,} from '../redux/CartSlice';
        ...
        {cartItems?.length === 0 ? <CartEmpty backToHome={backToHome} /> : <div>
          ...
          <div className="fixed bottom-0 bg-white w-full px-5 py-2 grid items-center">
            <div className="flex items-center justify-between">
              ...
              <h1 className="text-sm rounded bg-theme-cart text-slate-100 px-1 py-0.5">${cartTotalAmount}</h1>
            </div>
